      ...
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit}>
          <label className="block mb-4">
            <span className="text-xs uppercase tracking-widest text-white/50 mb-2 block">Name</span>
            <input
              type="text"
              value={name}
              onChange={(e) => setName(e.target.value)}
              placeholder="Optional"
              className="w-full rounded-lg px-4 py-3 text-white border border-white/20 focus:border-white/60 focus:outline-none transition-colors placeholder-white/30"
        ...
        <p className="mt-6 text-center text-white/40 text-sm">
          ...
          <a href="/auth/signin" className="text-white underline hover:text-white/80">Sign in</a>
        </p>
      </div>
    </main>
  );
